...
const App = () => {
  return (
    <div className="employers-wrapper-m">
      <div className="e-collaspible-wrapper">
        <Collapsible trigger="Healthcare" className="e-collapsible-m">
        ...
        <Collapsible trigger="Technology" className="e-collapsible-m">
          <p className="collapsible-p">
